	...
	<div class="row justify-content-center">
		<div class="col-xl-8">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<form method="post" action="<?=base_url('klien/tambah')?>">
						...
						<table class="table" style="width: 100%">
							...
							<tr>
								...
								<td style="width: 100%" class="float-left">
									<input type="text" class="form-control" placeholder="Nama Penanggung Jawab" name="penanggung_jawab" required="">
								</td>
							</tr>
							<tr>
								<td style="width: 20%; color: #000000">Email</td>
								<td style="width: 100%" class="float-left">
									<input type="email" class="form-control" placeholder="Email Penanggung Jawab" name="email_penanggung_jawab" required="">
								</td>
							</tr>
							<tr>
