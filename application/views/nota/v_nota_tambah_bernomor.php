	...
	<div class="row">
		<div class="col-xl-12">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<form method="post" action="<?=base_url().'nota/tambah_bernomor'?>">
						<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
						<table class="table">	
							<tr>
								<td colspan="2" align="right"><a href="<?=base_url().'nota/tambah'?>">Belum punya nomor? Klik Disini</a></td>
							</tr>
							<tr>
								<td>Kode</td>
								<td>
							...
							<tr>
								<td style="width: 20%; color: #000000">Nomor Nota</td>
								<td>
